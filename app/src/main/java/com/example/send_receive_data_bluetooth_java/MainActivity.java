package com.example.send_receive_data_bluetooth_java;
...
public class MainActivity extends Activity {
    ...
    Button btnOn, btnOff;
    TextView txtArduino, txtString, txtStringLength, sensorView0, sensorView1, sensorView2, sensorView3,get_data;
    Handler bluetoothIn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txtStringLength =  findViewById(R.id.txtArduino);
    ...
    public void onResume() {
        ...
        BluetoothDevice device = btAdapter.getRemoteDevice("98:D3:31:FD:2A:B9");
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Log.d("Data","readMessage:"+ readMessage.toString());
